...
class App extends Component {
  ...
  render() {
    ...
    return (
      ...
      <MoviesList movies={this.state.movies}/> // Step 12: Inside the selfclosing tag, give it an attribute called movies, and pass it this.state.movies inside a set of curly bracket.
    );
  }
}
