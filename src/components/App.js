import React, { Component } from 'react'; // Step 1: Import React, and Component from react. // Step 2: Import render from react-dom
...
class App extends Component {// Step 4: Write a class called App, extending Component.
    constructor() {// Step 5: Write a constructor function without passing anything into it.
        ...
        this.state = {// Step 7: Inside the constructor function, create a state on this, and set it to an object.
            movies: ['Wedding Crashers', 'Grandmas Boy', 'Pineapple Express']// Step 8: Inside the object, set a key to movies, and the value to an array of movies
        };
    }
    render() {// Step 9: Write a render function.
        return (// Step 10: Inside the render function, write a return statement.
        <MoviesList movies={this.state.movies} />// Step 11: Inside the return statement, write a selfclosing tag called MoviesList, 
